# 1 the function used to display Python?
#ANSWER print()#print() its the function for print something like print("hello world")

# 2 in python which data type is used to store a whole num
#(intenger)

# 3 Which of the following data types is used to store text in Python?
# in Python is str (string)

# 4 what is thr result   of the expression 10+5*2 in python?
#the result of the expression 10+5*2=20
...
#way to assign the value 42 to a varriable named answer in python is answer = 42
...
#the primiary putpose of adding coments its: better explanation of code for better understanding

#9 How can you take user input in Python?
# its can been taken input() function
...
# operation between True and False in Python answer is False

# 16 What will the expression (5 > 3) and (10 < 20) evaluate to in Python?
# (5 > 3) and (10 < 20) in Python evaluates to True
...
# in Python is a for loop

# 19 What type of loop is used when you want to repeat a block of code as long as a condition is true?
# is used when you want to repeat a block of code as long as a condition is true in Python
...
# we use "else" only if all elements in code are false
...
# you can use indexing like this: list[2]
